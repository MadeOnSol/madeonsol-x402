...
export interface WalletPnlResponse {
  ...
  notes:            { cost_basis_observable_from: string; truncated_trades?: number; trades_through?: string; trades_through_block_time?: number; trades_through_same_second?: number };
  cache_hit?:       boolean;
  computed_at?:     string;
  ttl_seconds?:     number;
