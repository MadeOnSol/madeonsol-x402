...
export declare function createClient(apiKeyOrPrivateKey: string, baseUrl?: string, paymentPolicy?: SolanaPaymentPolicy): MadeOnSolX402;
...
export declare class MadeOnSolREST {
     ...
     */
    testWebhook(webhookId: number, options?: WebhookTestOptions): Promise<WebhookTestResult>;
     ...
     */
    deployerAsOf(wallet: string, opts?: {
        date?: string;
    }): Promise<DeployerAsOfResponse>;
    /**
     ...
     * store it.
     */
    copyTradeUpdate(id: number, params: CopyTradeUpdateParams): Promise<CopyTradeUpdateResponse>;
